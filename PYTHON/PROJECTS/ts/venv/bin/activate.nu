...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/kmiller/Code/LANG/Python/PROJECTS/ts/venv'
    let bin = 'bin'
    let path_sep = ':'
...
alias deactivate = source '/home/kmiller/Code/LANG/Python/PROJECTS/ts/venv/bin/deactivate.nu'
